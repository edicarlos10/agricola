...
class Prevision_model extends CI_Model
{

    var $table = 'lancamento';
    var $column_order = array('clientes.nome, clientes_planos.id', 'planos.vlr', 'nro_boleto', 'dia_plano', 'nome_cidade'); //set column field database for datatable orderable
    ...
    var $order = array('lancamento.id' => 'desc'); // default order 
    ...
    public function negativise($table, $where, $data)
    {
