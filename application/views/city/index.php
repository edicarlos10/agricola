...
<html>
    ...
    <body>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <br />
                <button class="btn btn-success" onclick="add_city()"><i class="glyphicon glyphicon-plus"></i> Novo</button>
    ...
    <?= $this->load->view('city/js', null, true) ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Nome da Cidade</h3>
                </div>
